...
const { router, addNewsHandler, removeNewsHandler } = require('./router.js').router;
const { router, addNewsHandler, removeNewsHandler } = require('./router.js').addNewsHandler;
const { router, addNewsHandler, removeNewsHandler } = require('./router.js').removeNewsHandler;
app.use('/', router);
